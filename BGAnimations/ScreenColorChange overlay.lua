...
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=function(self)
		xy(frameX[1],frameY):halign(0):valign(1):zoom(0.6):settext("Category:")
	end;
}

t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=function(self)
		xy(frameX[2],frameY):halign(0):valign(1):zoom(0.6):settext("Name:")
	end;
}

t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=function(self)
		xy(frameX[3],frameY):halign(0):valign(1):zoom(0.6):settext("Color:")
	end;
}
